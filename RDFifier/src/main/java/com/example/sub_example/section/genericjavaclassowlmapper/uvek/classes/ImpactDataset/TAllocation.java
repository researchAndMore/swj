...
@XmlType(name = "TAllocation", namespace = "http://www.EcoInvent.org/EcoSpold01Impact", propOrder = {
    "referenceToInputOutput"
})
public class TAllocation {

    @XmlElement(namespace = "http://www.EcoInvent.org/EcoSpold01Impact", type = Integer.class)
