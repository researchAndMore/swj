 ...
 * generated in the flowPropertyDataSet package. 
...
public class ObjectFactory {
    ...
    private final static QName _FlowPropertyDataSet_QNAME = new QName("http://lca.jrc.it/ILCD/FlowProperty", "flowPropertyDataSet");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: flowPropertyDataSet
     * 
     */
    ...
    /**
     * Create an instance of {@link FlowPropertyDataSetType }
     * 
     */
    public FlowPropertyDataSetType createFlowPropertyDataSetType() {
        return new FlowPropertyDataSetType();
    }
    ...
    /**
     * Create an instance of {@link FlowPropertiesInformationType }
     * 
     */
    public FlowPropertiesInformationType createFlowPropertiesInformationType() {
        return new FlowPropertiesInformationType();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link FlowPropertyDataSetType }{@code >}
     * 
     * @param value
     *     Java instance representing xml element's value.
     * @return
     *     the new instance of {@link JAXBElement }{@code <}{@link FlowPropertyDataSetType }{@code >}
     */
    @XmlElementDecl(namespace = "http://lca.jrc.it/ILCD/FlowProperty", name = "flowPropertyDataSet")
    public JAXBElement<FlowPropertyDataSetType> createFlowPropertyDataSet(FlowPropertyDataSetType value) {
        return new JAXBElement<FlowPropertyDataSetType>(_FlowPropertyDataSet_QNAME, FlowPropertyDataSetType.class, null, value);
    }
