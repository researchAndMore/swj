...
@XmlType(name="TValidActivityNames", propOrder={"contextName", "activityName", "any"})
public class TValidActivityNames {
    protected List<TString80> contextName;
    @XmlElement(required=true)
    protected List<TValidActivityName> activityName;
    ...
    public List<TValidActivityName> getActivityName() {
        if (this.activityName == null) {
            this.activityName = new ArrayList<TValidActivityName>();
        }
