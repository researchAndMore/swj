...
@XmlType(name="TValidGeographies", propOrder={"contextName", "geography", "any"})
public class TValidGeographies {
    protected List<TString80> contextName;
    @XmlElement(required=true)
    protected List<TValidGeography> geography;
    ...
    public List<TValidGeography> getGeography() {
        if (this.geography == null) {
            this.geography = new ArrayList<TValidGeography>();
        }
