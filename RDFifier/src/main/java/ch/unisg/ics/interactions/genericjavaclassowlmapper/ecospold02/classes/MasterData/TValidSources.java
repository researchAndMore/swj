...
@XmlType(name="TValidSources", propOrder={"contextName", "source", "any"})
public class TValidSources {
    protected List<TString80> contextName;
    @XmlElement(required=true)
    protected List<TValidSource> source;
    ...
    public List<TValidSource> getSource() {
        if (this.source == null) {
            this.source = new ArrayList<TValidSource>();
        }
        return this.source;
    }
