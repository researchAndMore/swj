...
@XmlType(name="TValidCompartments", propOrder={"contextName", "compartment", "any"})
public class TValidCompartments {
    protected List<TString80> contextName;
    @XmlElement(required=true)
    protected List<TValidCompartment> compartment;
    ...
    public List<TValidCompartment> getCompartment() {
        if (this.compartment == null) {
            this.compartment = new ArrayList<TValidCompartment>();
        }
