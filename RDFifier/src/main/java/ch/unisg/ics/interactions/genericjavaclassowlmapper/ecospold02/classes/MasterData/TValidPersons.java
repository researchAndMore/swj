...
@XmlType(name="TValidPersons", propOrder={"contextName", "person", "any"})
public class TValidPersons {
    protected List<TString80> contextName;
    @XmlElement(required=true)
    protected List<TValidPerson> person;
    ...
    public List<TValidPerson> getPerson() {
        if (this.person == null) {
            this.person = new ArrayList<TValidPerson>();
        }
        return this.person;
    }
