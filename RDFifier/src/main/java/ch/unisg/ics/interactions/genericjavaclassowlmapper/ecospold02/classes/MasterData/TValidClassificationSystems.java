...
@XmlType(name="TValidClassificationSystems", propOrder={"contextName", "classificationSystem", "any"})
public class TValidClassificationSystems {
    protected List<TString80> contextName;
    @XmlElement(required=true)
    protected List<TValidClassificationSystem> classificationSystem;
    ...
    public List<TValidClassificationSystem> getClassificationSystem() {
        if (this.classificationSystem == null) {
            this.classificationSystem = new ArrayList<TValidClassificationSystem>();
        }
