...
@XmlType(name="TValidIntermediateExchanges", propOrder={"contextName", "requiredContext", "intermediateExchange", "any"})
public class TValidIntermediateExchanges {
    protected List<TString80> contextName;
    protected List<TRequiredContextReference> requiredContext;
    @XmlElement(required=true)
    protected List<TValidIntermediateExchange> intermediateExchange;
    ...
    public List<TValidIntermediateExchange> getIntermediateExchange() {
        if (this.intermediateExchange == null) {
            this.intermediateExchange = new ArrayList<TValidIntermediateExchange>();
        }
