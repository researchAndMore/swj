...
@XmlType(name="TValidElementaryExchanges", propOrder={"contextName", "requiredContext", "elementaryExchange", "any"})
public class TValidElementaryExchanges {
    protected List<TString80> contextName;
    protected List<TRequiredContextReference> requiredContext;
    @XmlElement(required=true)
    protected List<TValidElementaryExchange> elementaryExchange;
    ...
    public List<TValidElementaryExchange> getElementaryExchange() {
        if (this.elementaryExchange == null) {
            this.elementaryExchange = new ArrayList<TValidElementaryExchange>();
        }
