...
@XmlType(name="TValidTags", propOrder={"contextName", "tag", "any"})
public class TValidTags {
    protected List<TString80> contextName;
    @XmlElement(required=true)
    protected List<TValidTag> tag;
    ...
    public List<TValidTag> getTag() {
        if (this.tag == null) {
            this.tag = new ArrayList<TValidTag>();
        }
        return this.tag;
    }
