...
@XmlType(name = "TAllocation", namespace = "http://www.EcoInvent.org/EcoSpold01", propOrder = {
    "referenceToInputOutput"
})
public class TAllocation {

    @XmlElement(namespace = "http://www.EcoInvent.org/EcoSpold01", type = Integer.class)
