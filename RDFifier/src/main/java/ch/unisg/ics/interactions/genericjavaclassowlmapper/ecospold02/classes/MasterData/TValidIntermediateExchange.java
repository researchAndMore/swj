...
@XmlType(name="TValidIntermediateExchange", propOrder={"name", "unitName", "classification", "comment", "synonym", "property", "productInformation", "any"})
public class TValidIntermediateExchange {
