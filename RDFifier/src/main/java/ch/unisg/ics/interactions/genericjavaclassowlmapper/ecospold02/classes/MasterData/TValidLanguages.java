...
@XmlType(name="TValidLanguages", propOrder={"contextName", "language", "any"})
public class TValidLanguages {
    protected List<TString80> contextName;
    @XmlElement(required=true)
    protected List<TValidLanguage> language;
    ...
    public List<TValidLanguage> getLanguage() {
        if (this.language == null) {
            this.language = new ArrayList<TValidLanguage>();
        }
