...
@XmlType(name="TValidSystemModels", propOrder={"contextName", "systemModel", "any"})
public class TValidSystemModels {
    protected List<TString80> contextName;
    @XmlElement(required=true)
    protected List<TValidSystemModel> systemModel;
    ...
    public List<TValidSystemModel> getSystemModel() {
        if (this.systemModel == null) {
            this.systemModel = new ArrayList<TValidSystemModel>();
        }
