...
@XmlType(name="TValidParameters", propOrder={"contextName", "requiredContext", "parameter", "any"})
public class TValidParameters {
    protected List<TString80> contextName;
    protected List<TRequiredContextReference> requiredContext;
    @XmlElement(required=true)
    protected List<TValidParameter> parameter;
    ...
    public List<TValidParameter> getParameter() {
        if (this.parameter == null) {
            this.parameter = new ArrayList<TValidParameter>();
        }
