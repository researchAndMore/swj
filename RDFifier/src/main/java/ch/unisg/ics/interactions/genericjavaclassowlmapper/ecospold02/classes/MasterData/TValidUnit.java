...
@XmlType(name="TValidUnit", propOrder={"name", "comment", "any"})
public class TValidUnit {
    @XmlElement(required=true)
    protected List<TString40> name;
    ...
    public List<TString40> getName() {
        if (this.name == null) {
            this.name = new ArrayList<TString40>();
        }
        return this.name;
    }
