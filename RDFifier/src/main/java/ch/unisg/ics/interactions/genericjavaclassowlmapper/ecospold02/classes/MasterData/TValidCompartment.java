...
@XmlType(name="TValidCompartment", propOrder={"name", "comment", "subcompartment", "any"})
public class TValidCompartment {
    @XmlElement(required=true)
    protected List<TCompartmentName> name;
    protected List<TString32000> comment;
    @XmlElement(required=true)
    protected List<TValidSubcompartment> subcompartment;
    ...
    public List<TValidSubcompartment> getSubcompartment() {
        if (this.subcompartment == null) {
            this.subcompartment = new ArrayList<TValidSubcompartment>();
        }
