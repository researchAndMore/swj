...
@XmlType(name="TValidMacroEconomicScenarios", propOrder={"contextName", "macroEconomicScenario", "any"})
public class TValidMacroEconomicScenarios {
    protected List<TString80> contextName;
    @XmlElement(required=true)
    protected List<TValidMacroEconomicScenario> macroEconomicScenario;
    ...
    public List<TValidMacroEconomicScenario> getMacroEconomicScenario() {
        if (this.macroEconomicScenario == null) {
            this.macroEconomicScenario = new ArrayList<TValidMacroEconomicScenario>();
        }
