...
@XmlType(name="TValidCompanies", propOrder={"contextName", "company", "any"})
public class TValidCompanies {
    protected List<TString80> contextName;
    @XmlElement(required=true)
    protected List<TValidCompany> company;
    ...
    public List<TValidCompany> getCompany() {
        if (this.company == null) {
            this.company = new ArrayList<TValidCompany>();
        }
        return this.company;
    }
