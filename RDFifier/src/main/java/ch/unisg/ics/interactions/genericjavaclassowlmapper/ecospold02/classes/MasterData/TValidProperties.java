...
@XmlType(name="TValidProperties", propOrder={"contextName", "requiredContext", "property", "any"})
public class TValidProperties {
    protected List<TString80> contextName;
    protected List<TRequiredContextReference> requiredContext;
    @XmlElement(required=true)
    protected List<TValidProperty> property;
    ...
    public List<TValidProperty> getProperty() {
        if (this.property == null) {
            this.property = new ArrayList<TValidProperty>();
        }
